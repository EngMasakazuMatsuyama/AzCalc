...
1. Objective-C Bridging Header file (`AzCalcS1-Bridging-Header.h`).
...
2. Precompiled Header file (`AzCalcS1-Prefix.pch`).
We are using the PCH file to conveniently import the Swift Bridging Header file (`AzCalc-Swift.h`)

3. A Swift conversion of the original PCH file (`AzCalcS1-Prefix.swift`).
This file is always created to force generation of the Swift Bridging Header file (`AzCalc-Swift.h`) by Xcode itself, every time the project is compiled successfully.
